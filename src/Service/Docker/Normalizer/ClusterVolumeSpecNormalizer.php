...
class ClusterVolumeSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\ClusterVolumeSpec' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\ClusterVolumeSpec' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\ClusterVolumeSpec();
        ...
        if (\array_key_exists('AccessMode', $data)) {
            $object->setAccessMode($this->denormalizer->denormalize($data['AccessMode'], 'App\\Service\\Docker\\Model\\ClusterVolumeSpecAccessMode', 'json', $context));
        }
    ...
    {
        return ['App\\Service\\Docker\\Model\\ClusterVolumeSpec' => false];
    }
}
