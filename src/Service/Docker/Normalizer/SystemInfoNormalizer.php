...
class SystemInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\SystemInfo' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\SystemInfo' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\SystemInfo();
        ...
        if (\array_key_exists('Plugins', $data)) {
            $object->setPlugins($this->denormalizer->denormalize($data['Plugins'], 'App\\Service\\Docker\\Model\\PluginsInfo', 'json', $context));
        }
        ...
        if (\array_key_exists('RegistryConfig', $data) && null !== $data['RegistryConfig']) {
            $object->setRegistryConfig($this->denormalizer->denormalize($data['RegistryConfig'], 'App\\Service\\Docker\\Model\\RegistryServiceConfig', 'json', $context));
        ...
        if (\array_key_exists('GenericResources', $data)) {
            ...
            foreach ($data['GenericResources'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'App\\Service\\Docker\\Model\\GenericResourcesItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Runtimes', $data)) {
            ...
            foreach ($data['Runtimes'] as $key => $value_4) {
                $values_4[$key] = $this->denormalizer->denormalize($value_4, 'App\\Service\\Docker\\Model\\Runtime', 'json', $context);
            }
        ...
        if (\array_key_exists('Swarm', $data)) {
            $object->setSwarm($this->denormalizer->denormalize($data['Swarm'], 'App\\Service\\Docker\\Model\\SwarmInfo', 'json', $context));
        }
        ...
        if (\array_key_exists('ContainerdCommit', $data)) {
            $object->setContainerdCommit($this->denormalizer->denormalize($data['ContainerdCommit'], 'App\\Service\\Docker\\Model\\Commit', 'json', $context));
        }
        if (\array_key_exists('RuncCommit', $data)) {
            $object->setRuncCommit($this->denormalizer->denormalize($data['RuncCommit'], 'App\\Service\\Docker\\Model\\Commit', 'json', $context));
        }
        if (\array_key_exists('InitCommit', $data)) {
            $object->setInitCommit($this->denormalizer->denormalize($data['InitCommit'], 'App\\Service\\Docker\\Model\\Commit', 'json', $context));
        }
        ...
        if (\array_key_exists('DefaultAddressPools', $data)) {
            ...
            foreach ($data['DefaultAddressPools'] as $value_6) {
                $values_6[] = $this->denormalizer->denormalize($value_6, 'App\\Service\\Docker\\Model\\SystemInfoDefaultAddressPoolsItem', 'json', $context);
            }
    ...
    {
        return ['App\\Service\\Docker\\Model\\SystemInfo' => false];
    }
}
