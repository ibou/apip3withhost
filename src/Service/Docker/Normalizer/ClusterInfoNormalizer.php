...
class ClusterInfoNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\ClusterInfo' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\ClusterInfo' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\ClusterInfo();
    ...
    {
        return ['App\\Service\\Docker\\Model\\ClusterInfo' => false];
    }
}
