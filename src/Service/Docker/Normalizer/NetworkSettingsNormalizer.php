...
class NetworkSettingsNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\NetworkSettings' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\NetworkSettings' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\NetworkSettings();
        ...
        if (\array_key_exists('Ports', $data)) {
            ...
            foreach ($data['Ports'] as $key => $value) {
                ...
                foreach ($value as $value_1) {
                    $values_1[] = $this->denormalizer->denormalize($value_1, 'App\\Service\\Docker\\Model\\PortBinding', 'json', $context);
                }
                $values[$key] = $values_1;
            }
        ...
        if (\array_key_exists('SecondaryIPAddresses', $data) && null !== $data['SecondaryIPAddresses']) {
            ...
            foreach ($data['SecondaryIPAddresses'] as $value_2) {
                $values_2[] = $this->denormalizer->denormalize($value_2, 'App\\Service\\Docker\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('SecondaryIPv6Addresses', $data) && null !== $data['SecondaryIPv6Addresses']) {
            ...
            foreach ($data['SecondaryIPv6Addresses'] as $value_3) {
                $values_3[] = $this->denormalizer->denormalize($value_3, 'App\\Service\\Docker\\Model\\Address', 'json', $context);
            }
        ...
        if (\array_key_exists('Networks', $data)) {
            ...
            foreach ($data['Networks'] as $key_1 => $value_4) {
                $values_4[$key_1] = $this->denormalizer->denormalize($value_4, 'App\\Service\\Docker\\Model\\EndpointSettings', 'json', $context);
            }
    ...
    {
        return ['App\\Service\\Docker\\Model\\NetworkSettings' => false];
    }
}
