...
class ClusterVolumeNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\ClusterVolume' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\ClusterVolume' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\ClusterVolume();
        ...
        if (\array_key_exists('Info', $data)) {
            $object->setInfo($this->denormalizer->denormalize($data['Info'], 'App\\Service\\Docker\\Model\\ClusterVolumeInfo', 'json', $context));
        }
        if (\array_key_exists('PublishStatus', $data)) {
            $values = [];
            foreach ($data['PublishStatus'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'App\\Service\\Docker\\Model\\ClusterVolumePublishStatusItem', 'json', $context);
            }
    ...
    {
        return ['App\\Service\\Docker\\Model\\ClusterVolume' => false];
    }
}
