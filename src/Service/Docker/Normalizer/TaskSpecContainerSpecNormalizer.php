...
class TaskSpecContainerSpecNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\TaskSpecContainerSpec' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\TaskSpecContainerSpec' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\TaskSpecContainerSpec();
        ...
        if (\array_key_exists('Privileges', $data)) {
            $object->setPrivileges($this->denormalizer->denormalize($data['Privileges'], 'App\\Service\\Docker\\Model\\TaskSpecContainerSpecPrivileges', 'json', $context));
        }
        ...
        if (\array_key_exists('Mounts', $data)) {
            ...
            foreach ($data['Mounts'] as $value_5) {
                $values_5[] = $this->denormalizer->denormalize($value_5, 'App\\Service\\Docker\\Model\\Mount', 'json', $context);
            }
        ...
        if (\array_key_exists('DNSConfig', $data)) {
            $object->setDNSConfig($this->denormalizer->denormalize($data['DNSConfig'], 'App\\Service\\Docker\\Model\\TaskSpecContainerSpecDNSConfig', 'json', $context));
        }
        if (\array_key_exists('Secrets', $data)) {
            $values_7 = [];
            foreach ($data['Secrets'] as $value_7) {
                $values_7[] = $this->denormalizer->denormalize($value_7, 'App\\Service\\Docker\\Model\\TaskSpecContainerSpecSecretsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Configs', $data)) {
            ...
            foreach ($data['Configs'] as $value_8) {
                $values_8[] = $this->denormalizer->denormalize($value_8, 'App\\Service\\Docker\\Model\\TaskSpecContainerSpecConfigsItem', 'json', $context);
            }
        ...
        if (\array_key_exists('Ulimits', $data)) {
            ...
            foreach ($data['Ulimits'] as $value_12) {
                $values_12[] = $this->denormalizer->denormalize($value_12, 'App\\Service\\Docker\\Model\\TaskSpecContainerSpecUlimitsItem', 'json', $context);
            }
    ...
    {
        return ['App\\Service\\Docker\\Model\\TaskSpecContainerSpec' => false];
    }
}
