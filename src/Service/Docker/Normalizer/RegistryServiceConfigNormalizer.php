...
class RegistryServiceConfigNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'App\\Service\\Docker\\Model\\RegistryServiceConfig' === $type;
    }

    public function supportsNormalization($data, $format = null, array $context = []): bool
    {
        return is_object($data) && 'App\\Service\\Docker\\Model\\RegistryServiceConfig' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = []): mixed
    {
        ...
        $object = new \App\Service\Docker\Model\RegistryServiceConfig();
        ...
        if (\array_key_exists('IndexConfigs', $data)) {
            ...
            foreach ($data['IndexConfigs'] as $key => $value_3) {
                $values_3[$key] = $this->denormalizer->denormalize($value_3, 'App\\Service\\Docker\\Model\\IndexInfo', 'json', $context);
            }
    ...
    {
        return ['App\\Service\\Docker\\Model\\RegistryServiceConfig' => false];
    }
}
